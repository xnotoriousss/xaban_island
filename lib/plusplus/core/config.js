ig.module(
    ...
    .defines(function () {
         ...
         */
        ig.CONFIG.CREATURE.REACTION_DISTANCE = 400;
         ...
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.NEEDS_LINE_OF_SIGHT_PREY = false;
         ...
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.CAN_WANDER_Y = true;
         ...
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.WANDER_SWITCH_CHANCE = 0.05;
         ...
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.WANDER_SWITCH_CHANCE_STOPPED = 0.01;
