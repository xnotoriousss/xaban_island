...
.defines(function(){ "use strict";
	...
	ig.EntityPlayer = ig.global.EntityPlayer = ig.Player.extend({
	    ...
	    activate: function () {
			...
			this.inventory = new ig.Inventory(this, {
				 numSlots: 6
			 });
			 
			 this.crafting = new ig.Crafting(this, {
				 numSlots: 4
			 });
			 
			 this.equipment = new ig.EquipmentContainer(this, {
			 });
		},
		...
		activateHeat: function() {
			this.components.heat.active = true;
		},
		
		deactivateHeat: function() {
			this.components.heat.active = false;
		},
		...
		updateTempRegeneration: function() {
			...
			if (this.equipment) {
				...
				if (lightWeapon) {
					this.equipment.damageWeapon(this.equipment.getWeaponData().tool.duraLoss)
				}
			}
		},
