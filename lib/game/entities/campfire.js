...
.defines(function () {
	...
	ig.EntityCampfire = ig.global.EntityCampfire = ig.Character.extend(/**@lends ig.EntityCheckpoint.prototype */{
        ...
        components: {
            heat: {
                optimumDistance: 100, // the distance at which a calculated adjusted temperature will equal base temperature
                baseTemperature: 105, //threshold for player gain heat(fahrenheit)
                cookable: true
            },
        },
