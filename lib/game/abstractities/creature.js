    ...
    ig.Creature.inject({
		...
		updateTamer: function () {
            ...
            if( tamer ) {
                ...
                }else if (tamer.lastDamager && this.distanceSquaredTo(tamer.lastDamager) < this.tetherDistance * this.tetherDistance){
					this.prey = tamer.lastDamager;
				}
